...
$(() => {
    ...
    ***********************************/
    ...
    const actMini = (ele,seq,fn)=>{
        ...
        // 3. 위치값 알아내기
        // 위치 : li seq번방 -> bd변수에 있는 모든 li 중 seq번
        let room = bd.eq(seq);
        // 위치값 배열변수
        let pos = [];
        ...
        // left 위치값 : 방에서 중간이동(+li가로크기 절반 - 미니언즈가로크기절반)
