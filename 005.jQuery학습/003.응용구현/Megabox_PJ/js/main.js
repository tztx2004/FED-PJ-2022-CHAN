...
$(function () { //// jQB2 //////////////////////////
    ...
    // 대상 : .bntpp
    // 제이쿼리 메서드 : hover(function1,function2)
    $(".btnpp img").hover(function(){ // 진한이미지 =
        let csrc = $(this).attr("src")
        // 이미지 경로변경하기 : .png -> -1.png
    ...
    mv.on("timeupdate",function(){
        // 목표 : 비디오가 재생중일 대 진행바가 움직이게 한다
        // 원리: 진행 바의 진행비율을 %로 나타내야한다!
        ...
        if(!isNaN(ftime)){
            ...
            tBar.css({width:percent.toFixed(2)+"%"})
        }
