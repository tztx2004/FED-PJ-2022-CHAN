...
/********************************************** 
    ...
    2. 햄버거버튼 전체멘 보이기/숨기기(OK)
    + 전체메뉴 배경동영상 보일 때만 재생(숨길때 멈춤)
...
// 드래그끝난 후 이벤트 함수 만들기
slide.on("dragstop touchend",function(){
