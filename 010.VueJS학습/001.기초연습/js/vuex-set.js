...
/***************************************************************** 
    ...
    3. 설치 :
        ...
        (2) Vue CLI 방식 : npm설치
            ...
            Vue.use(VueRouter) -> 뷰JS에서 라우터 사용등록필수!
        
        (3) 뷰 인스턴스 객체 내부에 옵션으로 반드시!!!!
        등록해줘야 사용할 수 있다!!
        예) new Vue({
            el:"#app"m
            router, -> 등록필수!!
        ...
        참고) router 변수와 옵션 routes 변수는
            변경불가하다! 이미 라이브러리에서 변수명을 제한하고 있다!

    4. 버전 : Vue 2.x 버전일 경우 Vue Router 3.x버전을 사용함!

    5. 내장 컴포넌트 
        (1) <router-view> : 라우터와 일치하는 컴포넌트를 랜더링함
...
new Vue({
    ...
    // 순수 데이터 일때는 처음 뷰인스턴스가
    // 생성된 후인 created메서드 구역에 셋팅하자!
    created(){
    ...
    mounted(){
        ...
        function showBx(){
            $("main img").css({opacity:0}).delay(500).fadeTo(300,1);
            $("main p").css({opacity:0}).delay(1000).fadeTo(300,1);
        }//////////// showBx //////////////
    }////////////////// mounted //////////////////
});////////////////// Vue 인스턴스 ////////////////////