...
// 컴포넌트 호출하기2
ReactDOM.render(<Developer isDev={false} isrc={wisrc[1]} ialt='"개" 발자' />, document.querySelector("#root2"))
    ...
    return(
        <React.Fragment>
            ...
            {/* 음식 위시리스트의 길이가 0보다 클때만 출력 */}
            {
                ...
                <div>
                    <h2>
                        개발자가 좋아하는 음식은 모두 {myfood.length}가지
                        입니다.
                    </h2>
                    <ul>
                        {
            ...
            {/* 다른 경우 출력은 별도의 JSX출력 중괄호 추역에 코딩 */}
            {
                myfood.length ==0 &&
...
// 2-3. 개발자 선호 영화리스트 출력 컴포넌트 ///
function WishList2(props){ // wlist 속성에 담아 보내준다!
    // 위시리스트 담기
...
//         <React.Fragment>
//             <h1>개발자가 좋아하는 영화</h1>
//             <h2>개발자가 좋아하는 영화는 모두 {mdata.length}가지 입니다!!</h2>
//             <ul>
//                 {
//                     mdata.map(x=>
//                         <h2>
...
// ReactDOM.render(<Movies/>,document.querySelector("#root4"))


/**************************************************************** 
    3. 조건연산자(삼항연산자)를 사용하여 조건부 랜더링하기
****************************************************************/
...
// 3-2. 전체 출력 컴포넌트/////
// 구성: 전체타이틀(Title컴포넌트) + 변경버튼 + 작가와 그림출력(MakeWork컴포넌트)
// 특이사항: 변경버튼 클릭 시 MakeWork컴포넌트의 데이터를 변경하여
// 다시 출력하도록한다!
    ...
    return(
        <React.Fragment>
            ...
            {/* 3. 작품출력 : 3항연산자로 작품변경하기 */}
            {
                ...
                <MakeWork painter="모네" wname="양산쓴여인" />
            }
