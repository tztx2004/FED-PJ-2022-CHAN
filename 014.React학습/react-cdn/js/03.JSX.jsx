...
/************************************************************* 
    ...
    - appendChild() 메서드 없이 DOM에 요소 넣기 가능함!
...
/************************************************************* 
    ...
    [ JSX를 사용하거나 사용하지않는 경우 ]
    -> 개발자의 선택사항이다!
    -> JSX는 ES6기반의 JS언어의 확장이며
...
const mydata = [
    {idx:1,name:"김수현",movie:"도둑들"},
    {idx:2,name:"장우혁",movie:"멀라"},
    {idx:3,name:"김혜수",movie:"타짜"},
]

// map(value,index,array)을 사용한 태그생성하기
// map(배열값,순번,배열객체값)을 사용한 태그생성하기
...
*************************************************************/
const myele7 =
<h1 className="myclass">className 속성으로 클래스 셋팅!</h1>
